...
function Hero() {
  return (
    <div className="relative min-h-screen flex flex-col md:flex-row md:items-center md:px-[4vw] md:space-x-[2vw]">
      <img
        src={heroBg}
        className="absolute top-0 left-0 w-full h-[92%] z-[-10] md:h-[96%] md:w-[96%] md:top-[50%] md:left-[50%] md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-[1.4vw] lg:h-[96%] lg:w-[98%]"
        alt=""
      />
      <div className="mt-10 flex justify-center md:absolute md:top-[4%] md:left-[50%] md:translate-x-[-50%] md:mt-0 lg:top-[6%] ">
        <img src={set4U} alt="" className="w-[6rem] md:w-[10vw]" />
      </div>
      <div className="relative h-[auto] flex-1 py-[2rem] px-[1.7rem] pb-0 md:px-0 md:py-0 lg:max-w-[46%]">
        <img
          src={set4you}
          className="w-full sm:max-w-[20rem] sm:mx-auto md:max-w-[auto] md:min-w-full "
          alt=""
        />
        ...
        <div className="flex items-center space-x-4 justify-center mt-8 cursor-pointer md:space-x-[2vw] md:mt-[4vw] lg:mt-[2.6vw]">
          <ScrollLink
            to="explaination"
            offset={-200}
      ...
      <div className="w-[90%] mx-auto relative mt-[-18%] z-[-10] sm:max-w-[24rem] sm:mx-auto md:mt-0 md:max-w-none md:w-[44vw] md:min-w-[44vw] lg:absolute lg:top-[52%] lg:right-[4vw] lg:translate-y-[-50%] lg:w-[44vw] lg:min-w-[44vw] ">
